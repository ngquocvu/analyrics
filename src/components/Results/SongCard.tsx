...
export default function SongCard({ song, onSelect, index }: SongCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[--neon-cyan] via-[--neon-purple] to-[--neon-cyan] rounded-2xl opacity-0 group-hover:opacity-75 md:group-hover:opacity-100 blur-sm md:blur transition-all duration-500 animate-gradient-x"></div>
            ...
            <div className="relative glass-panel group-hover:glass-panel-hover group-active:scale-[0.98] transition-all duration-300 p-4 rounded-2xl flex items-center gap-4 h-full">
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-lg text-white group-hover:text-[--neon-cyan] truncate transition-colors duration-300">
                        {song.title}
                    </h3>
